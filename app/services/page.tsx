                  ...
                  >
                    ...
                    <div className="product-features">
                      ...
                      <ul>
                        ...
                        {p.features.length > 6 && (
                          <li className="features-more">+{p.features.length - 6} more features</li>
                        )}
                      </ul>
                    </div>
      ...
      {selectedProduct && product && (
        <div className="modal-overlay" onClick={() => setSelectedProduct(null)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <span className="product-category-label" style={{ marginBottom: 8 }}>{product.category}</span>
            <h3>Purchase {product.name}</h3>
            <p className="muted" style={{ marginTop: 8, fontSize: 14 }}>{product.tagline}</p>
            <p className="muted" style={{ marginTop: 12 }}>
              <strong>{formatPrice(product.priceUSD, currency)}</strong> &mdash; one-time payment. Complete source code with documentation.
            </p>
            {product.originalPriceUSD && (
              <p className="muted" style={{ fontSize: 13 }}>
                <span className="product-price--old" style={{ fontSize: 14 }}>{formatPrice(product.originalPriceUSD, currency)}</span>
                &nbsp;Save {Math.round((1 - product.priceUSD / product.originalPriceUSD) * 100)}%
              </p>
            )}
